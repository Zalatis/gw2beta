...
description = "GW2BOT - Pour tous vos besoins GW2\n-----------------------------------"
...
def initialize(bot_class=Bot, formatter_class=Formatter):
    ...
    async def on_command_error(error, ctx):
        ...
        if isinstance(error, commands.MissingRequiredArgument):
            ...
            message = ("Quelque chose a mal tourné. Si le problème persiste, contactez l'auteur. ")
            ...
            await bot.send_message(channel, "Commande non autorisée "
                                            "en message privé")
        elif isinstance(error, commands.CommandOnCooldown):
            await bot.send_message(channel, "Vous ne pouvez pas utiliser cette commande pour les prochaines "
                                            "{:.2f} secondes"
